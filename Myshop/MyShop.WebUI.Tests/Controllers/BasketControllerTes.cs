...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckout()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "joeshmoe@gman.com", ZipCode = "00000" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("joeshmoe@gman.com", "Forms"), null);
